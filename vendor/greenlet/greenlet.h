...
/* filament: on Pythons too old for the vendored greenlet sources (< 3.10)
   ...
   This boundary MUST match the stub floor in greenlet.cpp (both at 3.10):
   the vendored core needs the 3.10+ ``cframe``, so 3.8 and 3.9 both fall
   back to the classic greenlet capsule. */
